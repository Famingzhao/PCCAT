...
scRemoveBatch_seuratV4 = function(seurat.data, 
                         batchID = "Data.sets", 
  ...
  cat("Welcome to cite our article <PMID: 39418984. Integrated single-cell transcriptomic analyses identify a novel lineage plasticity-related cancer cell type involved in prostate cancer progression>.\n")
  cat("##################################\n")
...
seurat.harmony <- scRemoveBatch_seuratV4(seurat.data = seurat.data, methods = "harmony")
seurat.CCA <- scRemoveBatch_seuratV4(seurat.data = seurat.data, methods = "CCA")
seurat.RPCA <- scRemoveBatch_seuratV4(seurat.data = seurat.data, methods = "RPCA")
seurat.fastMNN <- scRemoveBatch_seuratV4(seurat.data = seurat.data, methods = "fastMNN")
seurat.LIGER <- scRemoveBatch_seuratV4(seurat.data = seurat.data, methods = "LIGER")
conos.data <- scRemoveBatch_seuratV4(seurat.data = seurat.data, methods = "conos")
